...
const Projects = [
  {
    ...
    short: "https://cdn.jsdelivr.net/gh/Hamza-Alarja/videos@main/system.mp4",
    features: [
    ...
    link: "https://homelesswap.finance/",
    sourceCode: "https://github.com/Hamza-Alarja/system",
  },

  {
    ...
    short: "https://cdn.jsdelivr.net/gh/Hamza-Alarja/videos@main/homeless.mp4",
    features: [
    ...
    link: "https://homelessswap.com/",
    sourceCode: "Private Repository (Frontend contribution only)",
  },
  {
    title: "VIDMAX",
    description:
      "A YouTube clone built with React, featuring video streaming, search, and user interface similar to YouTube",
    short: "https://cdn.jsdelivr.net/gh/Hamza-Alarja/videos@main/vidmax.mp4",
    features: ["Responsive", "Video streaming", "Search functionality"],
    technologies: ["React", "JavaScript", "YouTube API"],

    link: "https://hamza-alarja.github.io/vidmax/#/",
    sourceCode: "https://github.com/Hamza-Alarja/vidmax",
  },
];
